...
{
@private
    id<UIMenuBarDelegate>  __weak _delegate;
    NSMutableArray        *_items;
    UIMenuBarItem         *__weak _selectedItem;
    UIColor               *_tintColor;
...
@property (nonatomic, weak) id<UIMenuBarDelegate> delegate;     // weak reference. default is nil
@property (nonatomic, copy)   NSMutableArray       *items;
@property (nonatomic, weak) UIMenuBarItem        *selectedItem; // will show feedback based on mode. default is nil
